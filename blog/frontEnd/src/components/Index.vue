<template>
    <div>
        <section class="row featured-post-carousel">
            <div class="item post">
                <img src="../assets/images/featured-posts/1.jpg" alt="" class="img-responsive main-bg">
            ...
            <div class="item post">
                <img src="../assets/images/featured-posts/1-1.jpg" alt="" class="img-responsive main-bg">
                <div class="post-content">
                    <div class="container">
                        <h5 class="post-meta"><i>in</i> <a href="#">Author Profile</a> | <a href="#">feb 17, 2016</a></h5>
                        <h2 class="post-title"><a href="single.html">Nature, in the broadest sense, is the natural, physical, or material world or universe.</a></h2>
            ...
            <div class="item post">
                <img src="../assets/images/featured-posts/1-2.jpg" alt="" class="img-responsive main-bg">
                <div class="post-content">
                    <div class="container">
                        <h5 class="post-meta"><i>in</i> <a href="#">Author Profile</a> | <a href="#">feb 17, 2016</a></h5>
                        <h2 class="post-title"><a href="single.html">Nature, in the broadest sense, is the natural, physical, or material world or universe.</a></h2>
            ...
            <div class="container">
                <div class="row" id="post-masonry">
                    ...
                    <article class="col-sm-4 post post-masonry post-format-image">
                        <div class="post-wrapper row">
                            <div class="featured-content row">
                                <a href="single.html"><img src="../assets/images/posts/masonry/1.jpg" alt="" class="img-responsive"></a>
                            </div>
                            <div class="post-excerpt row">
                                ...
                                <footer class="row">
                                    ...
                                    <div class="response-count"><img src="../assets/images/comment-icon-gray.png" alt="">5</div>
                                </footer>
                            </div>
                        </div>
                    </article>
                    ...
                    <article class="col-sm-4 post post-masonry post-format-image">
                        <div class="post-wrapper row">
                            <div class="featured-content row">
                                <a href="single.html"><img src="../assets/images/posts/masonry/2.jpg" alt="" class="img-responsive"></a>
                            </div>
                            <div class="post-excerpt row">
                                <h5 class="post-meta">
                                    <a href="#" class="date">feb 17, 2016</a>
                    ...
                    <aside class="col-sm-4 widget-author widget widget-with-posts post">
                        <div class="widget-author-inner row">
                            <div class="author-avatar row"><a href="#"><img src="../assets/images/author.png" alt="" class="img-circle"></a></div>
                        ...
                        <div class="post-wrapper row">
                            <div class="featured-content row">
                                <div class="gallery-of-post">
                                    <div class="item"><img src="../assets/images/posts/masonry/3.jpg" alt=""></div>
                                    <div class="item"><img src="../assets/images/posts/masonry/3.jpg" alt=""></div>
                                    <div class="item"><img src="../assets/images/posts/masonry/3.jpg" alt=""></div>
                                    <div class="item"><img src="../assets/images/posts/masonry/3.jpg" alt=""></div>
                                    <div class="item"><img src="../assets/images/posts/masonry/3.jpg" alt=""></div>
                    ...
                    <article class="col-sm-4 post post-masonry post-format-video">
                        <div class="post-wrapper row">
                            <div class="featured-content row">
                                <a href="single.html">
                                    <img src="../assets/images/posts/masonry/4.jpg" alt="" class="img-responsive">
                                    <img src="../assets/images/play-btn.png" alt="" class="video-mark">
                                </a>
                            </div>
                            <div class="post-excerpt row">
                                <h5 class="post-meta">
                        ...
                        <div class="post-wrapper row">
                            <div class="post-excerpt row">
                                ...
                                <footer class="row">
                                    ...
                                    <div class="response-count"><img src="../assets/images/comment-icon-white.png" alt="">5</div>
                                </footer>
                            </div>
                        </div>
                    </article>
